...
#define GROW_ANIMATION_DURATION_SECONDS 0.10
#define SHRINK_ANIMATION_DURATION_SECONDS 0.20
#define FIRST_ANIMATION_DURATION_FACTOR 1.0
#define SUBSEQUENT_ANIMATION_DURATION_FACTOR 0.5
#define FIRST_BALL_BLOOM_FACTOR       2.0
#define FIRST_LABEL_BLOOM_FACTOR      ( 0.75 * FIRST_BALL_BLOOM_FACTOR      )
