...
//  Top-level view controller in the SporadicM24 application
//
...
// If so, I'm thinking to change what is now call SporadicM24View* to MainView* and use the names
// SporadicM24View* for the common superclass.  Slightly too much C12H22O11 for $0.10 at the moment.
...
- (void)loadMainViewController {
    SporadicM24ViewController *viewController = [[SporadicM24ViewController alloc] initWithNibName:@"SporadicM24View" bundle:nil];
